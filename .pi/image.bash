...
# Set Up policingnetworkcosmos
chmod +x /usr/bin/policingnetworkcosmosd /usr/bin/policingnetworkcosmoscli
mkdir -p /policingnetworkcosmos/config
systemctl enable policingnetworkcosmosd
